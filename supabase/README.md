...
Tablas ya creadas (los scripts que las crean están en `supabase/sql/`, en el orden en que se fueron aplicando; `007`, `008` y `009` también vienen juntos en `INSTALAR_BASE_DE_DATOS.sql` de la entrega del 23/09/2026):
